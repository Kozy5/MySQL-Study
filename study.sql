...
반올림 ROUND(a,b) a값을 소수점 뒤 b번째 숫자 반올림적용.(b+1 숫자가 반올림 희생)

ex ROUND(1234.5678) = 1235 // ★ B 미기재 시 정수로 만들어줌(소수점 첫번째를 반올림희생)
ex ROUND(1234.5678,1) = 1234.6 
ex ROUND(1234.56789 ,-1) =1230
...
FROM FIRST_HALF H
LEFT JOIN JULY J ON H.SHIPMENT_ID = J.SHIPMENT_ID
GROUP BY 1
) A
) B
WHERE RANKING <= 3
